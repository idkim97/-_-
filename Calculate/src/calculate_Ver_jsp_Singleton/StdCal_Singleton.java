...
public class StdCal_Singleton extends CalAbstract{
	private static StdCal_Singleton sin = new StdCal_Singleton();
	
	private StdCal_Singleton() {}
	
	public static StdCal_Singleton getInstance() {
		return sin;
	}
